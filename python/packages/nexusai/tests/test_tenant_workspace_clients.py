...
def test_rest_tenant_workspace_paths():
    api = FakeAPI()
    ...
    client.get_tenant_workspace("workspace-1")
    client.list_tenant_workspaces(page=1)
    ...
    assert api.calls == [
        (
            ...
            "/v1/tenant-workspaces",
            {
                ...
                "checkpoint_bucket": "checkpoints-a",
                "tokenizer_bucket": "tokenizers-a",
                "tenant_gpus_quota": 16,
            },
        ),
        ("GET", "/v1/tenant-workspaces/workspace-1", None),
        ("GET", "/v1/tenant-workspaces", {"page": 1}),
    ]
