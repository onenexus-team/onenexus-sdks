...
class ModelRegistryClient:
    ...
    def get_model(self, model_id: str) -> dict[str, Any]:
        return self._api.get(f"/v1/models/{model_id}")
    ...
    def delete_model(self, model_id: str) -> None:
        self._api.delete(f"/v1/models/{model_id}")
    ...
    def create_model_version_from_checkpoint(
        ...
        return self._api.post(
            f"/v1/models/{model_id}/versions/from-checkpoint",
            body={
                "name": name,
    ...
    def get_model_version(
        ...
        return self._api.get(f"/v1/models/{model_id}/versions/{model_version_id}")
    ...
    def update_model_version(
        ...
        return self._api.patch(
            f"/v1/models/{model_id}/versions/{model_version_id}",
            body={
                "name": name,
                "status": status,
                "extras_data": extras_data,
    ...
    def list_model_version_files(
        ...
        return self._api.get(f"/v1/models/{model_id}/versions/{model_version_id}/files")
    ...
    def get_model_version_size(
        ...
        return self._api.get(f"/v1/models/{model_id}/versions/{model_version_id}/size")

    def delete_model_version(self, model_id: str, model_version_id: str) -> None:
        self._api.delete(f"/v1/models/{model_id}/versions/{model_version_id}")
    ...
    def create_upload_credential(
        ...
        return self._api.post(
            f"/v1/models/{model_id}/versions/{model_version_id}/upload",
            body={
    ...
    def create_download_credential(
        ...
        return self._api.post(
            f"/v1/models/{model_id}/versions/{model_version_id}/download",
            body={
                "expires_in": expires_in,
            },
        )
    ...
    def download_model(
        ...
        return DownloadResult(
            resource=model_version, credential=credential, files=files
        )
