...
class CreateUserRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/CreateUser
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new CreateUserRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/CreateUser", path_parameters)
    ...
    async def post(self,body: CreateUserRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CreateUserResponse]:
        ...
        return await self.request_adapter.send_async(request_info, CreateUserResponse, error_mapping)
    ...
    def with_url(self,raw_url: str) -> CreateUserRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: CreateUserRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return CreateUserRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class CreateUserRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
