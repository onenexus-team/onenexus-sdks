 ...
 */
export interface CasApiClient extends BaseRequestBuilder<CasApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CasApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCasApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CasApiClient>(requestAdapter, pathParameters, CasApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CasApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CasApiClientNavigationMetadata: Record<Exclude<keyof CasApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
